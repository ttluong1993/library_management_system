...
@section('content')
    ...
    {!! Form::open(array('route' => 'copies.store', 'data-parsley-validate' => '')) !!}		
		<div class="col-md-6">

			<h3>Copy Information</h3>

        {{ Form::label('book_id', 'Book ID* ') }}
				{{ Form::text('book_id', null, array('class' => 'form-control', 'required' => '', 'maxlength' => '255')) }}
				...
				{{ Form::select('type_of_copy', ['R' => 'Referenced', 'B' => 'Borrowable'], 'R', ['class' => 'form-control']) }}
        ...
        <div class="row">
					...
					<div class="col-md-6">
						{!! Html::linkRoute('books.show', 'Cancel', array($book->id), array('class' => 'btn btn-danger btn-lg btn-block', 'style' => 'margin-top: 20px;')) !!}						
					</div>
				</div>
