...
@section('content')
    ...
    {!! Form::model(null, ['route' => ['books.update', $book_id], 'method' => 'PUT']) !!}
		<div class="col-md-6">
        ...
        <div class="row">
					...
					<div class="col-md-6">
						{!! Html::linkRoute('books.show', 'Cancel', array($book_id), array('class' => 'btn btn-danger btn-lg btn-block', 'style' => 'margin-top: 20px;')) !!}						
					</div>
				</div>
